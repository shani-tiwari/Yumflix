  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`food partner, ${profile?.fullName}, food videos, recipes, official account, recipes, `}
        />
        <meta
          property="og:title"
          content={`${profile?.fullName} | Food Partner on YourAppName`}
        />
        <meta
          property="og:description"
          content={`Watch and save videos from ${profile?.fullName}. Explore their food creations and more.`}
        />
      </Helmet>
      <main className="profile-page">
        <section className="profile-header">
          ...
          <div className="profile-stats" role="list" aria-label="Stats">
            ...
            {foodPartner && (
              <>
                <Link className=" create-food" to={"/create-food"}>
                  {" "}
                  <svg
