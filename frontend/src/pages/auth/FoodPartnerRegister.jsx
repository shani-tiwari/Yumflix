  ...
  const handleSubmit = (e) => { 
    ...
    axios.post("https://yumflix.onrender.com/auth/food-partner/register", {
      ...
      .then(response => {
        ...
        navigate("/auth/food-partner/login"); // Redirect to create food page after successful registration
      })
      .catch(error => {
      ...
      <div className="auth-card" role="region" aria-labelledby="partner-register-title">
        ...
        <nav className="auth-alt-action" style={{marginTop: '-4px'}}>
          ...
          <div className="auth-alt-action">
            Already a partner? <Link to="/auth/food-partner/login">Sign in</Link>
          </div>
